...
const PROJECT_HOME_PAGE = 'https://github.com/a-h-i/progress-bot';
...
const MAX_SERIALIZATION_TRANSACTION_RETY = 10;
/**
...
export { BOT_TOKEN, DEFAULT_PREFIX, PROJECT_HOME_PAGE, BOT_NAME, VERSION_STRING, EMBED_FOOTER_ARGS, CAPITALIZED_BOT_NAME,
    ...
    REWARD_POOLS_WIKI_URL, MAX_INTERACTIVE_RETRY_COUNT, MAX_SERIALIZATION_TRANSACTION_RETY };
